  ...
  return (
    <style>{`
      ...
      /* ── The shelf ────────────────────────────────────────────────────────
         ...
         Safe inside the layer: its back-swipe only listens on a 36px strip at
         the very left edge, which carries touch-action: none, so a sideways
         drag over the covers is unambiguously this and never a dismissal. */
      .af-shelf {
