...
const EMPTY = {
  ...
  keeper_name: null,
  portrait_url: null,
  // beacon_source was here: the beacon's off switch, 2026-09-16 to
  // 2026-09-24. Every journal broadcasts now; the column stays in the table
  // (additive-only) and nothing reads or writes it.
  site_address: null,
  founded_at: null,
