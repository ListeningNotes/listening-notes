    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', color: 'var(--ink)', fontFamily: fonts.sans }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto', display: 'flex', alignItems: 'center', gap: '20px' }}>
          <a href="/" style={{ fontFamily: "'Nunito', sans-serif", fontWeight: 900, fontSize: '18px', color: 'var(--ink)', textDecoration: 'none', letterSpacing: '-0.02em', flexShrink: 0 }}>Listening Notes</a>
          <div style={{ display: 'flex', gap: '2px', flex: 1 }}>
            <a href="/" style={navLinkStyle}>← All entries</a>
            <span style={{ fontFamily: fonts.mono, fontSize: '10px', color: 'var(--ink-faint)', alignSelf: 'center', padding: '0 4px' }}>/</span>
            <span style={{ fontFamily: fonts.mono, fontSize: '10px', letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--ink-soft)', padding: '7px 12px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: '200px' }}>{entry.album}</span>
          </div>
          <NavBeacon />
        </div>
      </nav>
...
const navLinkStyle = {
  ...
  color: 'var(--ink-soft)', textDecoration: 'none', padding: '7px 12px', borderRadius: '8px',
