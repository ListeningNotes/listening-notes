  ...
  return (
    <div className="ab-page" style={{ background: 'var(--bg)', minHeight: '100vh', color: 'var(--ink)', fontFamily: fonts.sans }}>
      <style>{`
        ...
        /* Between beats, not before the first one. */
        .ab-prose .ab-subhead { margin-top: 40px; }
        .ab-block + .ab-block { margin-top: 44px; }
        ...
        <div className="ab-panel" key={section}>
          ...
          {section === 'about' && (
            <div className="ab-prose">
              ...
              <h2 className="ab-subhead" style={{ marginTop: 0 }}>An unfinished list</h2>
              <p>
              ...
              <h2 className="ab-subhead">Starting</h2>
              <p>
              ...
              <h2 className="ab-subhead">Evidence of an encounter</h2>
              <p>
              ...
              <h2 className="ab-subhead">Listening on purpose</h2>
              <p>
              ...
              <h2 className="ab-subhead">What it is becoming</h2>
              <p>
