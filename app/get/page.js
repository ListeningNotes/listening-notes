...
const STEPS = [
  ...
  { shot: '03-neon', head: 'Add the database', time: 'a minute',
    text: 'Under “Add Products” there is one row, Neon, with an Add button. Press it. A panel opens: leave the region as it is, switch the “Auth” toggle off (the journal has its own way in), keep the Free plan, press Continue, then Create. The panel closes when the database exists. Nothing here needs a card. Then press Deploy.' },
  { shot: '04-build', head: 'Wait for the build', time: 'two to three minutes',
    text: 'A log scrolls past, then Vercel says Congratulations and shows a picture of your site. Press the picture.' },
