...
const STEPS = [
  ...
  { shot: '04-build', head: 'Wait for the build', time: 'two to three minutes',
    text: 'A log scrolls past. Near the end it prints a box with a link in it. Open the link — it is how the site knows the person setting it up is the person who made it. Missed it? It is in the project’s Logs too, and printed again every time the site restarts until you have used it.' },
  { shot: '05-holding', head: 'Setup opens', time: 'a moment',
    text: 'The link lands on the first setup screen. If you reach the site some other way it says the journal isn’t ready yet, with a small “Set it up” underneath; press that and type the code printed under the link.' },
