...
-- reasons live in DECISIONS, which is where reasons go.
--
...
CREATE TABLE IF NOT EXISTS entries (
  ...
  rating text,
  favorite boolean DEFAULT false,
  -- background text was here: a model-written paragraph about the record,
  -- from when a post opened with one. Posts are the notes alone now, so it
  -- was written on every save and read by nothing. Dropped 2026-09-06.
  notes text,
